...
public class UpdateEmployee extends JFrame implements ActionListener {
    ...
    UpdateEmployee() {
        ...
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("School_Management_System/Icons/UPDATEEMP.jpg"));
        Image i1=img.getImage().getScaledInstance(840,600, Image.SCALE_SMOOTH);
        ImageIcon img1=new ImageIcon(i1);
        id1.setIcon(img1);
        
        id2=new JLabel ("UPDATE EMPLOYEE DETAILS");
        ...
        b1.setBounds(250,450,150,40);
        b2.setBounds(450,450,150,40);
           ...
           try {
               ...
               if (rs.next()) {
                   // String queryUpdate = "UPDATE Employee SET name = '" + name + "' WHERE id = " + id;
                    String queryUpdate = "UPDATE Employee SET name = '" + Name + "', salary = '" + Salary + "',department='"+department+"' WHERE id =" + id;
                    ...
                    JOptionPane.showMessageDialog(null, "No empname found with the given ID.");
                }

                 //Close the JFrame after update
               this.setVisible(false);
           } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(null, "Please enter valid values for ID and Salary.");
